...
gulp.task('js-build-admin-post-edit', () => {
  return buildJS(`${config.src.jsPath}/admin-post-edit.js`, config.dist.jsPath);
});

// All js-related tasks
gulp.task('js', gulp.series('es-lint-plugin', 'js-build-admin-post-edit'));
